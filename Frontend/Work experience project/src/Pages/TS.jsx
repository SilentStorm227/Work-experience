...
//               <th>Skill</th>
//               {people.map((person) => (
//                 <th key={person.userId}> {person.userId?.split("-")[0]} </th>
//               ))}
//             </tr>
//           </thead>
...
//                 {people.map((person) => (
//                   <td key={person.userId + row.key}>{person.technicalSkills?.[row.key] || "-"}</td>
//                 ))}
//               </tr>
//             ))}
//             <tr>
...
//                 : "-";
//                 return (<td key={person.userId + "overall"}><strong>{avg}</strong></td>);
//               })}
//             </tr>
